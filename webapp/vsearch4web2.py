...
@app.route('/')
def hello() -> '302':
    #Adjust the annotation to more clearly indicate what’s being returned by this function.
    #Recall that HTTP status codes in the 300-399 range are redirections, and 302 is what
    #Flask sends back to your browser when “redirect” is invoked.
    return redirect('/entry')
#Call Flask’s “redirect” function to instruct the browser to request an alternative URL
#(in this case, “/entry”).
